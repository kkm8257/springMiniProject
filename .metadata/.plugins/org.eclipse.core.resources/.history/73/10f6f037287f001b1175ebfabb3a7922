 ...
 https://itjy2.tistory.com/109 이미지 출력관련  -->
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
	...
	<div class="webtoon-div">
		...
		<div class="webtoonlist-div" style="padding-left: 120px;width: 80%;	margin-top: 40px;">
	<c:forEach items="${day_list }" var="list">
			

					<div class='webtoonlist-box' style="margin-bottom:30px;display:inline-flex;width: 400px;height: 150px;">
						<div class='box-left'>
							<img src='/filepath/${list.toon_thum }' style="width: 150px;	height: 150px;	border-radius: 15px;"
								class='webtoonlist-boximg'></div>
							<div class='box-right' style="	display: flex;	justify-content: center;align-items: center;flex-direction: column;	margin-left: 30px;">
								<div style="font-family: 'Sunflower', sans-serif;	font-weight: 600;font-size: 20px;">${list.toon_name }</div>
								<div style="font-family: applefont;	font-weight: 400;font-size: 15px;">${list.toon_author }</div>
							</div>
