...
<link rel="stylesheet" href="/resources/mycss/join.css">
...
<div class="join-div">
	...
	<form action="joinUser" method="post" id="form_id" class="join_form" onsubmit="return chk_result()"
		 name="form_name"  autocomplete='off'>
